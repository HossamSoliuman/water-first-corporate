...
class PageSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $pages = [
            ...
            ['slug' => 'company-overview', 'title' => 'WaterFirst Engineering Consultancy Private Limited', 'subtitle' => 'A Bangalore-based, water-led environmental and infrastructure engineering practice.', 'content' => '<p>WaterFirst develops sustainable technical solutions to challenging environmental problems across municipal and industrial water, wastewater and solids-management systems.</p><p>Founded by IIT Roorkee alumna Uma Upadhyay, the practice combines her 19 years of water and wastewater treatment experience with a wider team carrying 15–35 years across effluent treatment, sewerage, water supply, waterbody rejuvenation and plant operations.</p><p>We work with seawater, river water and groundwater; conventional and advanced treatment; contaminant removal; water-quality monitoring; public-health protection; and regulatory compliance. Every assignment is approached with customer focus, fiscal responsibility, close site interaction and time-bound delivery.</p>', 'sections' => null],
